...
const PRODUCTS = [
  ...
  { name: '3-Wheel Cargo Car', photo: 'threewheelcar' },
  { name: 'Baby Stroller Cart', photo: 'babycart' },
  { name: 'Shopping Bags Set', photo: 'bagsshopping' },
  { name: 'Wooden Bed Frame', photo: 'bedwooden' },
  { name: 'Dining Chairs Set', photo: 'chairsset' },
  { name: 'Charging Jack Adapter', photo: 'chargingjack' },
  { name: 'Casual Shoes', photo: 'disktjieshoes' },
  { name: 'Camera Drone', photo: 'dronecameranew' },
  { name: 'Handheld Fan', photo: 'fanhand' },
  { name: 'Electric Fan', photo: 'fanproductnew' },
  { name: 'Rice Cooker', photo: 'flakrice' },
  { name: "Men's Flip Flops", photo: 'fliteflipflops' },
  { name: 'Work Gloves', photo: 'handgloves' },
  { name: 'Slimming Suit', photo: 'hotslimsuit' },
  { name: 'Electric Juicer', photo: 'juicernew' },
  { name: 'Lemon Juice Bottle', photo: 'lemonjuice' },
  { name: 'Mini Tractor Toy', photo: 'minitractor' },
  { name: 'Mobile Desk Lamp', photo: 'mobilelamp' },
  { name: 'Smartphone', photo: 'mobilephonenew' },
  { name: 'Stainless Steel Set', photo: 'polishedsteel' },
  { name: 'Steel Water Bottle', photo: 'steelwaterbottle' },
  { name: 'Print Roll Paper', photo: 'printroll' },
  { name: 'Mini Printing Press', photo: 'printingpress' },
  { name: 'Smart Home Device', photo: 'qiangintelligent' },
  { name: 'Running Shoes', photo: 'roadrunner' },
  { name: 'School Backpack', photo: 'schoolbagnew' },
  { name: 'Scanner Device', photo: 'shortscan' },
  { name: 'Portable Speaker', photo: 'speakernew' },
  { name: 'Cotton T-Shirt', photo: 'tshirtnew' },
  { name: 'Leggings', photo: 'tites' },
  { name: 'Rubber Sole Shoes', photo: 'tyreshoes' },
  { name: 'Insulated Cooler Box', photo: 'vankoolcooler' },
  { name: 'Instant Water Heater', photo: 'waterheaternew' },
  { name: 'Spare Wheel', photo: 'wheelproduct' },
];
