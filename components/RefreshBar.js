...
/**
 * Wire up "load on mount + auto-poll every 1s while tab is visible + manual
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16, flexWrap: 'wrap' }}>
      ...
      <span style={{ fontSize: 11.5, color: '#6b7280', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {lastUpdated ? `Updated ${lastUpdated.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} · auto-refreshes every 1s` : 'Loading…'}
      </span>
      {extra}
